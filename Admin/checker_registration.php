    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form action="#" method="post" class="taker-form">
                ...
                <div class="form-group">
                    <label for="vehicletype">Specialization</label>
                    <input type="text" name="specialization" id="specialization" required placeholder="Enter the specialization">
                </div>
                <div class="form-group">
                    <label for="vehiclenumber">Experience years</label>
                    <input
                        type="text"
                ...
                <div class="form-group">
                    <label for="licensenumber">Certification Number	</label>
                    <input
                        type="text"
                ...
                <div class="form-group">
                    <label for="licensenumber">Certification Expiry</label>
                    <input
                        type="text"
                        name="certification_expiry"
                        id="certification_expiry"
                        required
                        placeholder="Enter the certification expiry">
                </div>
